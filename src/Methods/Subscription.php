...
use SistemAtc\Asaas\DTO\Request\Bill\ListSubscriptionRequestDTO;
use SistemAtc\Asaas\DTO\Request\Bill\CreateSubscriptionRequestDTO;
use SistemAtc\Asaas\DTO\Request\Bill\UpdateSubscriptionRequestDTO;
use SistemAtc\Asaas\DTO\Request\Bill\ConfigurationInvoicesRequestDTO;
use SistemAtc\Asaas\DTO\Response\Subscription\SubscriptionResponseDTO;
use SistemAtc\Asaas\DTO\Request\Bill\ListPaymentSubscriptionRequestDTO;
use SistemAtc\Asaas\DTO\Request\Bill\BookletPaymentSubscriptionRequestDTO;
use SistemAtc\Asaas\DTO\Response\Subscription\ListSubscriptionResponseDTO;
use SistemAtc\Asaas\DTO\Request\Bill\CreateSubscriptionCreditCardRequestDTO;
use SistemAtc\Asaas\DTO\Request\Bill\UpdateConfigurationInvoicesRequestDTO;
use SistemAtc\Asaas\DTO\Request\Bill\UpdateSubscriptionCreditCardRequestDTO;
